...
object TafProperties {
  ...
  const val CONFIG_REGISTRATION_ROUTE = "config.registration.route"
  const val CONFIG_REGISTRATION_ROUTE_WRONG = "config.registration.route.wrong"
}